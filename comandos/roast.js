...
const roasts = ["I'd offer you some gum but your smiles got plenty of it.",
...
module.exports.run = async (bot, message, args, ops) => {
    ...
    if(!member) return message.channel.send("É necessário mencionar o nome de um usuário para sofrer roast.").then(m => m.delete(2000));

    let result = Math.floor((Math.random() * roasts.length));



    
    let roastEmbed = new Discord.RichEmbed()
    .setColor(cores.azul)
    .setTitle("**Roast**")
	.setThumbnail(bot.user.displayAvatarURL)
    .addField("**Roast:**", roasts[result])
    .addField(`O ${member.user.tag} levou roast de ${message.author.tag}`);
...
module.exports.config = {
    name: "roast",
    description: "dá um roast a alguém.",
    usage: "! + roast + (usuário)",
    aliases: ["rst"],
